...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Przykłady:
  python main_refactored.py                    # Uruchom tylko analizę
  python main_refactored.py --mode analysis   # Uruchom tylko analizę
  python main_refactored.py --mode api        # Uruchom tylko serwer API
  python main_refactored.py --mode both       # Uruchom analizę, potem serwer API
  python main_refactored.py --mode api --port 8080  # Uruchom API na porcie 8080
        """
    )
